# FILE: v1/chunker.py
# PURPOSE: Split source books into bounded markdown chunks while preserving chapter and section boundaries where possible.
# OWNS: Legacy V1 chunk parsing, chapter grouping, recursive splitting, and chunk manifest writing.
...
from v1._paths import REPO_ROOT, resolve_config_path
...
def main(argv: list[str] | None = None) -> int:
    ...
    output_dir = Path(argv[1]) if len(argv) > 1 else REPO_ROOT / "output" / book_path.stem / "chunks"
