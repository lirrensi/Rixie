...
def _build_title_page(book_name: str, authors: list[str]) -> str:
    ...
    <div class="title-page">
        ...
        <div class="generator">Generated by <a href="https://github.com/lirrensi/Rixie">Rixie V2</a> &mdash; Knowledge Distillation Engine</div>
    </div>"""
...
def _build_end_page(book_name: str, chapter_count: int) -> str:
    ...
    <div class="end-page">
        ...
        <div class="attribution">
            ...
            <a href="https://github.com/lirrensi/Rixie">Rixie V2</a> Knowledge Distillation
        </div>
    </div>"""
...
def export_epub(workspace_dir: Path) -> Path:
    ...
    book.add_metadata("DC", "publisher", "Rixie V2 (github.com/lirrensi/Rixie)")
